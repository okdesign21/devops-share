...
if command -v docker compose >/dev/null 2>&1 && [ -f /opt/jenkins/docker-compose.yml ]; then
  docker compose -f /opt/jenkins/docker-compose.yml down || true
  docker compose -f /opt/jenkins/docker-compose.yml up -d || true
fi